...
inline static double magic_number = static_cast<double>(0x0018000000000000);
inline static double encoding_upper_limit = 9223372036854774784;
inline static double encoding_lower_limit = -9223372036854774784;
inline static uint8_t exception_position_size = 16;
inline static uint8_t exception_position_size_bytes = exception_position_size / 8;
inline static uint8_t exception_size = 64;
inline static uint8_t exception_size_bytes = exception_size / 8;
inline static uint8_t sampling_early_exit_threshold = 2;
inline static uint8_t max_exponent = 18;

inline static uint8_t rd_exception_position_size = 16;
inline static uint8_t rd_exception_position_size_bytes = rd_exception_position_size / 8;
inline static uint8_t rd_exception_size = 16;
inline static uint8_t rd_exception_size_bytes = rd_exception_size / 8;
inline static uint8_t dictionary_element_size_bytes = 2;
